...
- (id)parseJSONData:(NSData *)data error:(NSError **)error
{
    ...
    id result = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingMutableContainers error:nil];//[data objectFromJSONDataWithParseOptions:JKParseOptionStrict error:&parseError];
